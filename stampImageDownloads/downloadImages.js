...
// Load JSON file
const data = require('./stampData.json'); // Replace with your actual JSON file path

// Sort the data by date, handling cases where date might be missing or improperly formatted
const sortedData = data
    .filter(item => item.date && item.date[0] && item.date[0].content) // Filter out items without a valid date
    .sort((a, b) => parseInt(a.date[0].content) - parseInt(b.date[0].content)); // Sort by date

// Define the download folder
// Make sure this path is correct!
const downloadFolder = '/Users/toDownloadImages/stampImageDownloads'; // Ensure correct path
